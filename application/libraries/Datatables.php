  ...
  */
  class Datatables
  {
    ...
    */
    ...
    public function order_by($val, $val2)
    {
      $this->order_by[] = array($val, $val2);
      $this->ci->db->order_by($val, $val2);
      return $this;
    }
    ...
    */
    ...
    public function where_array($where, $val = NULL, $backtick_protect = TRUE)
    {
      $this->where[] = array($where, $val, $backtick_protect);
      $this->ci->db->where($where, $val, $backtick_protect);
      return $this;
    }
