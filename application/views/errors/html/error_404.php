...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?=base_url()?>assets/template/assets/pages/css/error.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" page-404-3">
        <div class="page-inner">
            <img src="<?=base_url()?>assets/template/assets/pages/media/pages/earth.jpg" class="img-responsive" alt=""> </div>
