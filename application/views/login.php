...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Login | PT. BASMALLAH UTAMA TOUR MALANG</title>
        ...
        <link rel="shortcut icon" href="<?=base_url('assets/logo.png')?>" /> </head>
    <!-- END HEAD -->
            ...
            <div class="row bs-reset">
                ...
                <div class="col-md-6 login-container bs-reset">
                    <div class="login-content">
                        <h1>PT. Basmallah Utama Tour Malang</h1>
                        <p> Silahkan masukkan <b>Username</b> beserta <b>Password</b>. </p>
                        ...
                        <div class="row bs-reset">
                            ...
                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>Web Report | &copy; PT. Basmallah Utama Tour Malang</p>
                                </div>
                            </div>
                        </div>
                    </div>
